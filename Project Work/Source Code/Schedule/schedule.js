...
function updateSchedule()
{
    ...
    {
        scheduleForm["shortfrequency"].value =parseInt(localStorage.getItem('shortfrequency'));
    }
    else
    {
    ...
    {
        scheduleForm["shortduration"].value = parseInt(localStorage.getItem('shortduration'));
    }
    else
    {
    ...
    {
        scheduleForm["longduration"].value = parseInt(localStorage.getItem('longduration'));
    }
    else{
    ...
    {
        scheduleForm["longfrequency"].value = parseInt(localStorage.getItem('longfrequency'));
    }
    else
    {
